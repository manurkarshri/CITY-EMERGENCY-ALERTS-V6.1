...
const responsiveCss = await fs.readFile(new URL("../css/responsive.css", import.meta.url), "utf8");
...
assert(responsiveCss.includes(".tabs{overflow-x:hidden}") && responsiveCss.includes(".tabs button{min-width:0;flex:1 1 0"), "All mobile tabs must fit without horizontal scrolling");
