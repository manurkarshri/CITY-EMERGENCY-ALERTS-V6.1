...
const payload = { incidents: [
  { geometry: { coordinates: [73.8, 18.5] }, properties: { id: "closed-1", iconCategory: 9, events: [{ description: "Road closed" }], from: "Aundh", to: "Baner", delay: 1200, startTime: "2026-07-11T05:30:00Z", endTime: "2026-07-11T09:00:00Z", lastReportTime: "2026-07-11T05:45:00Z" } },
  { geometry: { coordinates: [73.9, 18.6] }, properties: { id: "jam-small", iconCategory: 7, events: [{ description: "Slow traffic" }], delay: 300, startTime: "2026-07-11T05:30:00Z" } },
  { geometry: { coordinates: [73.7, 18.4] }, properties: { id: "jam-large", iconCategory: 7, events: [{ description: "Severe congestion" }], delay: 1800, startTime: "2026-07-11T05:30:00Z" } }
] };
